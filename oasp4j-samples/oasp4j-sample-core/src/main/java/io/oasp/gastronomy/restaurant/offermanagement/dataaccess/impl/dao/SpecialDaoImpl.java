...
public class SpecialDaoImpl extends ApplicationDaoImpl<SpecialEntity> implements SpecialDao {
  ...
  public PaginatedListTo<SpecialEntity> findSpecials(SpecialSearchCriteriaTo criteria) {
    ...
    activePeriod.setEndingDay(criteria.getActivePeriod().getEndingDay());
    activePeriod.setEndingHour(criteria.getActivePeriod().getEndingHour());
    activePeriod.setStartingDay(criteria.getActivePeriod().getStartingDay());
    activePeriod.setStartingHour(criteria.getActivePeriod().getStartingHour());
